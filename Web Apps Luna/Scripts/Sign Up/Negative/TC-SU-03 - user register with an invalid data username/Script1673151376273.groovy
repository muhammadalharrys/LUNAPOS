...
'user insert less username character (ex : a/1)'
WebUI.setText(findTestObject('Sign Up/field-username'), '1')

'user insert email'
WebUI.setText(findTestObject('Sign Up/field-email'), 'polsek@ydaah.com')
